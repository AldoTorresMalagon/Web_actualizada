          ...
          <div class="container">
            <div class="row align-items-center">
              ...
              <div class="col-md-6 text-center text-md-end">
                ...
                <a href="https://www.facebook.com/TecNMHuejutlaOficial/" target="_blank" class="footer-social-btn" aria-label="Facebook">
                  <i class="bi bi-facebook"></i>
                </a>
                <a href="https://instagram.com" target="_blank" class="footer-social-btn" aria-label="Instagram">
                  <i class="bi bi-instagram"></i>
                </a>
                <a href="https://x.com/TecNMHuejutla" target="_blank" class="footer-social-btn" aria-label="Twitter">
                  <i class="bi bi-twitter"></i>
                </a>
                <a href="https://www.youtube.com/channel/UCU5minsrNi_agfUcV2V3rKw" target="_blank" class="footer-social-btn" aria-label="YouTube">
        ...
        <div class="footer-links">
          <div class="container">
            <div class="row g-3">
              ...
              <div class="col-6 col-md-3">
                <h6 class="footer-col-title">
                  <i class="bi bi-cup-straw me-1"></i>Servicios
                </h6>
                <ul class="list-unstyled small">
              ...
              <div class="col-6 col-md-3">
                <h6 class="footer-col-title">
                  <i class="bi bi-building me-1"></i>Acerca de
                </h6>
                <ul class="list-unstyled small">
        ...
        <div class="footer-bottom">
          <div class="container">
            <div class="row align-items-center">
              ...
              <div class="col-md-6 text-center text-md-end">
                <p class="mb-0 small">
                  Hecho con <i class="bi bi-heart-fill text-danger"></i> por estudiantes ITH
                </p>
              </div>
            </div>
          </div>
